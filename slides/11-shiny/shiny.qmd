...
- [Another good presentation of data](https://research.hackerrank.com/student-developer/2024).
...
- Check the [Shiny cheat sheet](https://rstudio.github.io/cheatsheets/html/shiny.html) for a list of inputs and outputs.
...
- [Code](https://github.com/ucla-biostat-203b/2026winter/tree/main/slides/11-shiny/census-app) for the Shiny app `census-app`.
...
- [Code](https://github.com/ucla-biostat-203b/2026winter/tree/main/slides/11-shiny/stockVis) for the Shiny app `stockVis`.
