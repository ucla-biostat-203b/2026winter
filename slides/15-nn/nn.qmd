...
- _Attention? Attention!_ by Lilian Weng (2018): <https://lilianweng.github.io/posts/2018-06-24-attention/>
...
- The scoring is done via **dot-products**, illustrated below.
$$
...
Seq2seq encoder–decoder comparison. The encoder-decoder model, translating the sentence "she is eating a green apple" to Chinese. The visualization of both encoder and decoder is unrolled in time. Source: Lilian Weng (2018), [*Attention? Attention!*](https://lilianweng.github.io/posts/2018-06-24-attention/).
...
:::{#fig-weng-encoder-decoder-attention}

![](./weng_figures/fig4_encoder-decoder-attention.png){width=50%}
...
- RNNs and transformers have had big wins in speech modeling, language translation, and forecasting.
