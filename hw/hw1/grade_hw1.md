...
### Completeness, correctness and efficiency of solution: ??/90

- Q1 (??/10)

	Is the GitHub.com repository name set up correctly? If using name other than `biostat-203b-2026-winter`, take 5 points off.
